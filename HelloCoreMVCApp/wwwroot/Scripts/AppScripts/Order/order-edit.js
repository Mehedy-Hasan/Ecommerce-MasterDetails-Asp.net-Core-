    ...
    var t = $('#dtlTable').DataTable({
        "columnDefs": [
            ...
            
            {
                ...
                "data": null,
                "defaultContent":
                    "<a class='btn btn-info btn-sm js-dtlEdit'><i class='' aria-hidden='true'>Edit</i></a>" +
                    "<a class='btn btn-danger btn-sm js-dtlDelete'><i class='fa fa-trash' aria-hidden='true'>Delete</i></a>"
            }
